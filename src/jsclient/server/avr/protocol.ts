...
export const avrProtocolVersion = 0x71;
...
export interface AvrData {
    ...
    "u16 __current_sensor_adc_max_value": number,
    "u16 __current_sensor_adc_samples": number,
}
...
export function asAvrData(vals: {[id: string]: number}): AvrData { return {
    ...
    "u16 __current_sensor_adc_max_value": vals["G1"],
    "u16 __current_sensor_adc_samples": vals["G2"],
};}
