...
export interface AvrData {
    ...
    "CO2 sensor: u8 co2.get_rx_overflow_count()": number,
...
export function asAvrData(vals: {[id: string]: number}): AvrData { return {
    ...
    "CO2 sensor: u8 co2.get_rx_overflow_count()": vals["D1"],
    "CO2 sensor: u8 co2.get_crc_errors()": vals["D2"],
    "CO2 sensor: u16 co2.get_abc_setups()": vals["D3"],
    "CO2 sensor: u16 co2.get_concentration()": vals["D4"],
    "CO2 sensor: u8 co2.get_temperature()": vals["D5"],
    "CO2 sensor: u8 co2.get_s()": vals["D6"],
    "CO2 sensor: u16 co2.get_u()": vals["D7"],
    "CO2 sensor: u8 co2.get_updated_deciseconds_ago()": vals["D8"],
};}
