...
describe('AveragingWindow', () => {
    it('should work as expected on low sample frequency', () => {
    ...
    it('should work as expected on higher sample frequency', () => {
        const timeService = new TimeServiceMockImpl();
        const avg = new AveragingWindow({
            windowSpanSeconds: 1,
            sampleFrequency: 4, 
    ...
    it('should work as expected on even more higher sample frequency', () => {
        const timeService = new TimeServiceMockImpl();
        const avg = new AveragingWindow({
            windowSpanSeconds: 1,
            sampleFrequency: 6, 
    ...
    it('should work as expected on higher than even more higher sample frequency', () => {
        const timeService = new TimeServiceMockImpl();
        const avg = new AveragingWindow({
            windowSpanSeconds: 1,
            sampleFrequency: 8, 
    ...
    it('should work as expected on even higher than even more higher sample frequency', () => {
        const timeService = new TimeServiceMockImpl();
        const avg = new AveragingWindow({
            windowSpanSeconds: 1,
            sampleFrequency: 10, 
