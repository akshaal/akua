...
static u8 usart0_writer__status_code = 0;
...
#define status_code usart0_writer__status_code
...
static u8 usart0_writer__send_status__akat_coroutine_state = 0;
static u8 usart0_writer__send_status__send_status_copy__akat_coroutine_state = 0;
static u8 usart0_writer__send_status__send_status_copy() {
#define send_status_copy usart0_writer__send_status__send_status_copy
#define byte_number_to_send usart0_writer__byte_number_to_send
#define status_code usart0_writer__status_code
#define send_byte usart0_writer__send_byte
#define akat_coroutine_state usart0_writer__send_status__send_status_copy__akat_coroutine_state
#define byte_to_send usart0_writer__byte_to_send
#define send_status usart0_writer__send_status
    ;
    AKAT_HOT_CODE;
...
static u8 usart0_writer__send_status() {
#define send_status_copy usart0_writer__send_status__send_status_copy
#define byte_to_send usart0_writer__byte_to_send
#define status_code usart0_writer__status_code
#define send_byte usart0_writer__send_byte
#define akat_coroutine_state usart0_writer__send_status__akat_coroutine_state
#define byte_number_to_send usart0_writer__byte_number_to_send
#define send_status usart0_writer__send_status
    ;
    AKAT_HOT_CODE;
...
akat_coroutine_l_3:
            ...
            if (send_status_copy() != AKAT_COROUTINE_S_START) {
                return akat_coroutine_state;
            }
        } while (0);
...
//- - - - - - - - - - -
        ...
        while (1) { //Usart0 RX overflow counter
            status_code = 'A';
...
akat_coroutine_l_2:
                ...
                if (send_status() != AKAT_COROUTINE_S_START) {
                    return ;
                }
            } while (0);
